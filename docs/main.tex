...
\singlespacing
% --- Logo ---
\includegraphics[width=7cm,height=3cm]{biust.png}
\vspace{2cm}
% --- Title ---
\LARGE \textbf{Optimization of Traffic Light Control Systems for Urban Intersections in Palapye}
\vspace{3cm}
% --- Author details ---
\large
\textbf{Tsotlhe Nayang Seiphepi}\\
Student ID: 21001137\\
Department of Computer and Telecommunications Engineering\\
Botswana International University of Science and Technology
\vspace{3cm}
% --- Supervisor ---
\textbf{Supervisor:} Dr. Bokamoso Basutli
\vfill
% --- Date ---
\textbf{October 2025}
\end{titlepage}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Flow chart (Community) (1).png}
...
Large-scale networks require distributed RL where each intersection acts as an independent agent. MARL systems typically follow a centralized training, decentralized execution (CTDE) paradigm. Figure \ref{fig:marl_block} presents a clean MARL systems diagram.
...
% Top module
\node[block] (ctde) {Centralized Training Module};

% Three agents evenly spaced beneath
\node[agent, below=1.5cm of ctde, xshift=-4cm] (agent1) {Agent 1\\Intersection A};
\node[agent, below=1.5cm of ctde] (agent2) {Agent 2\\Intersection B};
\node[agent, below=1.5cm of ctde, xshift=4cm] (agent3) {Agent 3\\Intersection C};

% Training arrows
\draw[arrow] (ctde.south) -- (agent1.north);
\draw[arrow] (ctde.south) -- (agent2.north);
\draw[arrow] (ctde.south) -- (agent3.north);

% Downward execution arrows
\draw[arrow] (agent1.south) -- ++(0,-1) node[midway,right]{Execution};
\draw[arrow] (agent2.south) -- ++(0,-1);
\draw[arrow] (agent3.south) -- ++(0,-1);

\end{tikzpicture}
\caption{Centralized training and decentralized execution in Multi-Agent RL.}
\label{fig:marl_block}
\end{figure}
...
Figure~\ref{fig:methodology_architecture} shows the high-level architecture of the developed system.

\begin{figure}[h]
\centering
\includegraphics[width=0.95\linewidth]{methodology_architecture.png}
\caption{High-level architecture of the hybrid DRL--ML traffic signal control system.}
\label{fig:methodology_architecture}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.95\linewidth]{flowchart_adaptive_signal.png}
\caption{Flowchart of the implemented DRL-based adaptive traffic signal control system.}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\linewidth]{yolo_detection.png}
...
\begin{itemize}
    ...
    \item \textbf{Simulation duration:} Cars were made to spawn for a span of 5 minutes in both cases.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\linewidth]{fixed_time_sim.jpeg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\linewidth]{fixed_time_gantt.jpeg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\linewidth]{ppo_sim.png}
\caption{SUMO running with the PPO adaptive RL traffic signal controller.}
\label{fig:ppo_sim}
\end{figure}

\subsection{CameraVision / YOLO Detection}

If applicable, YOLO detection testing results can be included.

\begin{figure}[H]
\centering
\includegraphics[width=0.92\linewidth]{yolo_test_output.png}
...
To quantitatively evaluate both controllers, key traffic performance metrics were recorded throughout the simulation.

Five metrics were computed using TraCI:

\begin{itemize}
    \item \textbf{Average Delay}
    \item \textbf{Average Queue Length}
    \item \textbf{Throughput (vehicles exiting)}
    \item \textbf{Stop Ratio}
    \item \textbf{Intersection Pressure}
\end{itemize}

Graphs for each metric are shown below.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{metrics_fixed_time.png}
    \caption{Performance Metrics for Fixed Traffic Light Control System}
    \label{fig:metrics_fixed}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{metrics_ppo_model.png}
    \caption{Performance Metrics for PPO Model Traffic Light Controlled System}
    \label{fig:metrics_ppo}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\linewidth]{delay_comparison.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\linewidth]{queue_comparison.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\linewidth]{throughput_comparison.png}
\caption{Vehicle throughput comparison.}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\linewidth]{stop_ratio_comparison.png}
\caption{Stop ratio comparison.}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\linewidth]{pressure_comparison.png}
\caption{Intersection pressure comparison.}
